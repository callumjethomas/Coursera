...
Go to github.com and create a new repository, making sure the name is **exactly the same** as your R project name. Do **not** intialise a readme file, .gitignore or license.

Once created you will see a repository page with a section titled “Push an existing repository from the command line” with instructions below containing code on how to do so. In Git Bash or Terminal, copy and paste these lines of code to link your repository with GitHub. After doing so, refresh your GitHub page and reopen your project in R Studio. You should now have access to the Git tab in the upper right quadrant and can push to GitHub from within RStudio any future changes.